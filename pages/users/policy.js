import classes from "../../components/UI/ui-modules/policy.module.css";
const Policy = () => {
  return (
    <div className={classes.main}>
      <div className={classes.cover}>
        ...
        <ul>
          ...
          <li>
            <p>
              ...
              in this Agreement) refers to eventlinny.
            </p>
          </li>
          <li>
            <p>
          ...
          <li>
            <p>
              <strong>Website</strong> refers to eventlinny, accessible from{" "}
              <a
                href="https://eventlinny.vercel.app"
                rel="external nofollow noopener"
                target="_blank"
              >
                https://eventlinny.vercel.app
              </a>
            </p>
          </li>
          <li>
        ...
        <ul>
          <li>
            <h4>By email: kertesz.karoly@yahoo.com</h4>
          </li>
        </ul>
      </div>
    </div>
